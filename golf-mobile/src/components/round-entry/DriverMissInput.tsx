      ...
      <GestureDetector gesture={composed}>
        <View>
          <Svg width={SVG_WIDTH} height={SVG_HEIGHT}>
            ...
            {/* Track */}
            <Rect x={4} y={CENTER_Y - 3} width={SVG_WIDTH - 8} height={6} rx={3} fill={colors.inputBg} />
            {/* Center line */}
            <Line x1={CENTER_X} y1={8} x2={CENTER_X} y2={SVG_HEIGHT - 8} stroke={colors.textMuted} strokeWidth={1} strokeDasharray="3,3" />
            {/* Labels */}
            <SvgText x={8} y={14} fontSize={10} fill={colors.textMuted}>L</SvgText>
            <SvgText x={SVG_WIDTH - 14} y={14} fontSize={10} fill={colors.textMuted}>R</SvgText>
            {/* Golf ball */}
