...
const CATEGORY_COLORS: Record<string, { bg: string; text: string }> = {
  driving: { bg: "rgba(29,78,216,0.20)", text: "#60a5fa" },
  approach: { bg: "rgba(194,65,12,0.20)", text: "#fb923c" },
  shortGame: { bg: "rgba(13,148,136,0.20)", text: "#2dd4bf" },
  putting: { bg: "rgba(109,40,217,0.20)", text: "#a78bfa" },
};

const DIFFICULTY_COLORS: Record<string, { bg: string; text: string }> = {
  beginner: { bg: "rgba(30,64,175,0.20)", text: "#60a5fa" },
  intermediate: { bg: "rgba(133,77,14,0.20)", text: "#fbbf24" },
  advanced: { bg: "rgba(153,27,27,0.20)", text: "#f87171" },
};
    ...
    >
      <View style={styles.focusHeader}>
        ...
        <Text
          style={[
            styles.focusSG,
            { color: focus.sgValue >= 0 ? colors.primary : "#ef4444" },
          ]}
        >
          {focus.sgValue >= 0 ? "+" : ""}
...
const styles = StyleSheet.create({
  ...
  focusCardCritical: { borderColor: "rgba(252,165,165,0.4)" },
  focusCardModerate: { borderColor: "rgba(253,230,138,0.4)" },
  ...
  focusDesc: { fontSize: 13, color: colors.textSecondary, lineHeight: 19 },
  focusRec: { fontSize: 13, fontWeight: "500", color: colors.text, lineHeight: 19 },
  allocSection: { gap: 4 },
  allocLabels: { flexDirection: "row", justifyContent: "space-between" },
  allocLabel: { fontSize: 11, color: colors.textSecondary },
  drillsList: { gap: 4, paddingTop: 4 },
  drillsTitle: { fontSize: 12, fontWeight: "600", color: colors.text },
  drillRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  drillRowName: { fontSize: 12, color: colors.textSecondary },
  drillRowDuration: { fontSize: 12, color: colors.textSecondary },
  // Drill section
  drillSection: { gap: 10 },
  drillSectionHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  drillCount: { fontSize: 13, color: colors.textSecondary },
  // Drill card
  drillCard: { padding: 14, gap: 6 },
  drillHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 8 },
  drillName: { fontSize: 14, fontWeight: "600", color: colors.text, flex: 1 },
  drillBadges: { flexDirection: "row", gap: 4 },
  drillDesc: { fontSize: 12, color: colors.textSecondary, lineHeight: 17 },
  drillMeta: { flexDirection: "row", gap: 16 },
  drillMetaText: { fontSize: 11, color: colors.textMuted },
});
