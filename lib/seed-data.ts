import {
  ...
  LiveEventData, LiveEvent, LivePlayer, LiveScore,
} from "./types";
...
const STANDARD_PARS_LIVE = [4, 5, 4, 3, 4, 4, 3, 4, 5, 4, 4, 3, 5, 4, 4, 4, 3, 5];
...
function generateLiveScores(
  ...
  return holeScores.map((strokes, i) => ({
    id: `${eventId}-${playerId}-h${i + 1}`,
    eventId,
    playerId,
    holeNumber: i + 1,
    strokes,
    createdAt: new Date(new Date(baseTime).getTime() + i * 15 * 60000).toISOString(),
  }));
}
...
export function getSeedLiveEvents(): LiveEventData[] {
  ...
  const event1Scores = [
    ...
    ...generateLiveScores("seed-event-1", "seed-lp-2",
      [4, 5, 5, 3, 4, 4, 3, 5, 5, 4, 4, 3, 5, 4, 5, 4, 3, 5], "2026-02-01T09:00:00Z"),
    ...generateLiveScores("seed-event-1", "seed-lp-3",
      [4, 5, 4, 3, 4, 5, 3, 4, 5, 4, 4, 3, 5, 4, 4, 3, 3, 5], "2026-02-01T09:00:00Z"),
    ...generateLiveScores("seed-event-1", "seed-lp-4",
      [4, 5, 4, 3, 3, 4, 3, 4, 5, 4, 4, 2, 5, 4, 4, 4, 4, 5], "2026-02-01T09:00:00Z"),
  ];
  ...
  const event2Scores = [
    ...
    ...generateLiveScores("seed-event-2", "seed-lp-6",
      [5, 5, 4, 3, 5, 4, 3, 4, 5, 4, 5, 3, 5, 4, 5, 4, 3, 5], "2026-03-01T09:00:00Z"),
    ...generateLiveScores("seed-event-2", "seed-lp-7",
      [4, 5, 4, 3, 3, 4, 3, 4, 5, 4, 4, 3, 5, 4, 4, 3, 3, 5], "2026-03-01T09:00:00Z"),
    ...generateLiveScores("seed-event-2", "seed-lp-8",
      [4, 5, 4, 3, 4, 4, 3, 5, 5, 4, 4, 3, 5, 4, 4, 4, 3, 4], "2026-03-01T09:00:00Z"),
  ];
  ...
  return [
    {
      event: {
        id: "seed-event-1",
        name: "Summer Stroke Play",
        courseName: "Royal Wellington Golf Club",
        joinCode: "RWGC24",
        holePars: STANDARD_PARS_LIVE,
        status: "completed",
        createdAt: "2026-02-01T08:00:00Z",
      },
      players: event1Players,
      scores: event1Scores,
    },
    {
      event: {
        id: "seed-event-2",
        name: "Queenstown Pro-Am",
        courseName: "Millbrook Resort",
        joinCode: "QTWN26",
        holePars: STANDARD_PARS_LIVE,
        status: "completed",
        createdAt: "2026-03-01T08:00:00Z",
      },
      players: event2Players,
      scores: event2Scores,
    },
  ];
}
